...
* обрабатывать статические файлы
  ...
  + проверка 
    - `https://localhost:4443/staticfiles/your_static_file.css` (Статические файлы обслуживаются через Daphne)
  + Перейдите по адресу вашего приложения и убедитесь, что оно работает (Динамические запросы проксируются через Nginx к Daphne)
...
* Nginx для Обслуживания Статических Файлов
  ...
  + Проверьте Статические Файлы
    - `https://localhost:4443/staticfiles/admin/css/base.css` CSS-файл доступен
