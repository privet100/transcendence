...
* без Channel Layer
  + обрабатывать сообщения напрямую внутри процесса, используя функциональность Django Channels и ws-соединений, между клиентами в рамках одного процесса
...
* Асинхронный обмен сообщениями может работать и без Channel Layers, но с channel layers проще, масштабируемо
