...
* протокол tcp (Transmission Control Protocol)
  ...
  + сами данные передаются с помощью транспортного протокола TCP, обеспечивающего надежность соединения
  ...
  + альтернатива TCP: UDP (User Datagram Protocol), менее надежен, но быстрее
