...
+ процесс определения личности пользователя (например, предоставление username или email), ввод логина (`username`) или email  
+ без проверки пароля — это еще не вход в систему  


### AUTENTIFICATION = докажите, что это вы
* подтверждение личности
* доказательство, что пользователь действительно тот, за кого себя выдает  
* процесс логина (ввод пароля, вход через соцсети)
* пример: ввод пароля или вход через OAuth (Google, GitHub)  
