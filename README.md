...
### Итог
Даже если `ASGI_APPLICATION` кажется "неиспользуемой", она играет ключевую роль в настройке ASGI-сервера и связке вашего приложения с ним. Удалять её не следует, если вы используете ASGI-сервер.
