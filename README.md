...
* настройка Django Channels для поддержки системы каналов 
  ...
  + какой бэкэнд используется для обмена сообщениями: Redis
* промежуточный уровень для обработки событий в реальном времени
* не сервер
* асинхронный обмен сообщениями, интегрированную с Django Channels
...
* получил данные - публикует их в канал и доставляет подписанным
