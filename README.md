...
* maquette du site
  + онлайн-инструмент для дизайна пользовательских интерфейсов (UI/UX)
  + создавать прототипы сайтов, мобильных приложений, графические макеты  
  + рисовать макеты сайтов** (расположение кнопок, текстов, изображений и т.д.)
  + несколько человек могут редактировать макет одновременно
