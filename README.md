...
* Daphne для обработки ws и асинхронных событий

### `CHANNEL_LAYERS` (канал-сервер, канальный слой) для Django Channels
* абстракция в Django Channels
* не сервер
* позволяет частям приложения общаться друг с другом
* промежуточный уровень для обработки событий в реальном времени
* асинхронный обмен сообщениями
* для передачи сообщений между consumers и группами
* чтобы отправлять сообщения группе подключений, например, всем участникам чата
