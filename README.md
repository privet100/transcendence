...
* Django Channels предоставляет инфраструктуру для управления соединениями и маршрутизации сообщений
* публикует в канал, доставляет подписанным
* обеспечивают механизм передачи сообщений между частями приложения
  + ```
    [Клиент] 
        │ WebSocket / HTTP
        ▼
