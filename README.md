...
+ базовые подходы django
  + FBV — представления, основанные на функциях
  ...
  + class based views CBV
    ...
    - представления, реализованные как классы
    - предоставляют встроенную логику обработки запросов (`get()`, `post()` и т. д.).  
    - позволяют переопределять только нужные методы (`get`, `post`), а также использовать миксины
    - ООП-подход к представлениям 
...
* API = 5–10 эндпоинтов
  - например, группа всех маршрутов, связанных с чатом
