сделай, чтобы турнир работал так:
1. пользователь нажал на главной странице кнопку "создать турнио"
2. сразу же автоматически созлаётся турнир, в который дрбавляются все пользователи сайта
3. автоматчиески создаются игры случайным образом, если нечетное число игроков. одному наугад даётся от 0 до 10 очков
4. каждый получает случайно коичество очков от 0 до 10
5. на странице турнира есть пары кто с кем играет,  и их забитые очки напротив каждого
6. приглашений на игру нет, прилашений на турнир нет
7. турнир состоит из одного тура

делай всё в самом простом варианте
