...
### webhook
* механизм, который позволяет сторонним сервисам или вашим собственным вспомогательным сервисам отправлять уведомления (HTTP-запросы) на ваш сервер, когда у них что-то произошло
* способ «узнавать» о важных событиях в режиме реального времени, не перегружая сервер и внешние сервисы лишними запросами
